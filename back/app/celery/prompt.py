...
TITLE_PROMPT_WITH_CONTEXT = (
    ...
    "### Slide 3: Солнце \n\n ### Slide 4: Планеты земной группы \n\n ### Slide 5: Пояс астероидов \n\n"
    "### Slide 6: Газовые гиганты \n\n ### Slide 7: Плутон \n\n <<<AI_OUTPUT>>>"
    "You can use this helpfull content (may be empty): {content}"
)
...
SLIDE_PROMPT = (
    ...
    "Here is helfull context (may be empty): {context}"
    "Example: "
...
SLIDE_UPDATE = (
    ...
    "Current main text: {text}. Added text (may be empty): {added_text}. "
...
SUMMARIZE_PROMPT = (
    "You're an expert AI assistant in presentation. "
    "Given a user document, generate a summary. "
    "Structure it into {num_slides} main sections. Generate ONLY structure, not main text. "
    "Use clear headings. Maintain professional tone. "
    "Ensure logical flow between sections. Answer on Russian language."
)
